    ...
    getHtmlContent(): string {
        ...
        <head>
            ...
            <style>
                ...
                #modelDropdown { background: #252526; color: white; border: 1px solid #444; }
        ...
        <body>
            <div class="container">
                ...
                <div class="panel">
                    ...
                    <button id="selectModelButton">Select Model</button>
                    <button id="openModelButton">Assist with the Model</button>
                </div>
            ...
            <script>
                ...
                document.getElementById('selectModelButton').addEventListener('click', () => {
                    ...
                    if (selectedModel) {
                        ...
                        document.getElementById('openModelButton').style.display = 'block';
                    } else {
                        vscode.postMessage({ command: 'error', message: 'Please select a model first.' });
                    }
                });
    
                document.getElementById('openModelButton').addEventListener('click', () => {
                    const selectedModel = document.getElementById('modelDropdown').value;
